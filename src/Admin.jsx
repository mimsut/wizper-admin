  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16, alignItems: 'stretch' }}>
        ...
        <SettingGroup icon="coins" title="5 · 보상" onChange={log('보상')} rows={[['기본 참가비', '100,000원'], ['자기보고 설문 1회', '250원'], ['음성 과제 1회', '700원'], ['일일 보너스 조건', '당일 과제 전체 완료'], ['일일 보너스 금액', '800원'], ['지급 방식', '연구 종료 후 일괄']]} />
